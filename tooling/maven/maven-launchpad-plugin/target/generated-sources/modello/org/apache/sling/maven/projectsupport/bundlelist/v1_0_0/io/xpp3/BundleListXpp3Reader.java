...
public class BundleListXpp3Reader
{
     ...
     * @return Bundle
     */
    private Bundle parseBundle( String tagName, XmlPullParser parser, boolean strict )
        throws IOException, XmlPullParserException
    {
        ...
        while ( parser.nextTag() == XmlPullParser.START_TAG )
        {
            ...
            {
                bundle.setGroupId( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "artifactId", null, parsed ) )
            {
                bundle.setArtifactId( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "version", null, parsed ) )
            {
                bundle.setVersion( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "type", null, parsed ) )
            {
                bundle.setType( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "classifier", null, parsed ) )
            {
                bundle.setClassifier( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "startLevel", null, parsed ) )
            {
                bundle.setStartLevel( getIntegerValue( getTrimmedValue( parser.nextText() ), "startLevel", parser, strict ) );
            }
            else if ( checkFieldWithDuplicate( parser, "runModes", null, parsed ) )
            {
                bundle.setRunModes( getTrimmedValue( parser.nextText() ) );
            }
            else
            {
                if ( strict )
        ...
        return bundle;
    } //-- Bundle parseBundle( String, XmlPullParser, boolean )

    /**
     * Method parseBundleList.
     * 
     * @param tagName
     * @param strict
     * @param parser
     ...
     * @return BundleList
     */
    private BundleList parseBundleList( String tagName, XmlPullParser parser, boolean strict )
        throws IOException, XmlPullParserException
    {
        ...
        bundleList.setModelEncoding( parser.getInputEncoding() );
        while ( eventType != XmlPullParser.END_DOCUMENT )
        {
            if ( eventType == XmlPullParser.START_TAG )
            {
                ...
                else if ( parser.getName().equals( "startLevel" ) )
                {
                    java.util.List startLevels = bundleList.getStartLevels();
                    if ( startLevels == null )
                    {
                        startLevels = new java.util.ArrayList/*<StartLevel>*/();
                        bundleList.setStartLevels( startLevels );
                    }
                    startLevels.add( parseStartLevel( "startLevel", parser, strict ) );
                }
                else if ( strict )
                {
                    throw new XmlPullParserException( "Unrecognised tag: '" + parser.getName() + "'", parser, null );
        ...
        return bundleList;
    } //-- BundleList parseBundleList( String, XmlPullParser, boolean )

    /**
     * Method parseStartLevel.
     * 
     * @param tagName
     * @param strict
     * @param parser
     ...
     * @return StartLevel
     */
    private StartLevel parseStartLevel( String tagName, XmlPullParser parser, boolean strict )
        throws IOException, XmlPullParserException
    {
        StartLevel startLevel = new StartLevel();
        if ( parser.getAttributeValue( "", "level" ) != null  )
        {
            startLevel.setLevel( getTrimmedValue( parser.getAttributeValue( "", "level" ) ) );
        }
        java.util.Set parsed = new java.util.HashSet();
        while ( parser.nextTag() == XmlPullParser.START_TAG )
        {
            ...
            {
                java.util.List bundles = startLevel.getBundles();
                if ( bundles == null )
                {
                    bundles = new java.util.ArrayList/*<Bundle>*/();
                    startLevel.setBundles( bundles );
                }
                bundles.add( parseBundle( "bundle", parser, strict ) );
            }
            else
            {
                if ( strict )
        ...
        return startLevel;
    } //-- StartLevel parseStartLevel( String, XmlPullParser, boolean )
     ...
     * @return BundleList
     */
    public BundleList read( Reader reader, boolean strict )
        throws IOException, XmlPullParserException
    {
        ...
        parser.next();
        return parseBundleList( "bundles", parser, strict );
    } //-- BundleList read( Reader, boolean )
     ...
     * @return BundleList
     */
    public BundleList read( Reader reader )
        throws IOException, XmlPullParserException
    {
        return read( reader, true );
    } //-- BundleList read( Reader )
     ...
     * @return BundleList
     */
    public BundleList read( InputStream in, boolean strict )
        throws IOException, XmlPullParserException
    {
        Reader reader = ReaderFactory.newXmlReader( in );

        return read( reader, strict );
    } //-- BundleList read( InputStream, boolean )
     ...
     * @return BundleList
     */
    public BundleList read( InputStream in )
        throws IOException, XmlPullParserException
    {
        Reader reader = ReaderFactory.newXmlReader( in );

        return read( reader );
    } //-- BundleList read( InputStream )
